...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white-100 dark:bg-black-900 transition-colors duration-300">
   
      {/* <Navbar /> */}
      

      {/* Hero Section */}
    <section className="relative overflow-hidden flex flex-col min-h-screen items-center justify-center bg-white-100 dark:bg-black-900 text-slate-950 transition-bg ${darkMode ? 'dark' : ''}">
      ...
      [mask-image:radial-gradient(ellipse_at_100%_0%,black_10%,var(--transparent)_70%)]
          ...
          {/* Features Section */}
          <section id="features" className="py-24 bg-white-50 dark:bg-black-800/50">
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mx-auto text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white-900 mb-4">
                  Why Choose Shortly?
                </h2>
                <p className="text-xl text-gray-900 dark:text-white-200 mb-4">
